...
export const PartnersDashboard: React.FC = () => {
  return (
    <div className="p-8 border border-slate/15 bg-paper rounded-md text-center max-w-md mx-auto mt-12 space-y-3 shadow-sm">
      <h3 className="font-serif text-lg font-bold text-ink">Partnership Dashboard</h3>
      <p className="text-xs text-slate">Tracks partner profit shares, running capital ledger transactions, contributions, and withdrawals.</p>
